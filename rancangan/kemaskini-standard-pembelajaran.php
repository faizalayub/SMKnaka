...
<head>
	<?php
		...
		$dataset       = $API->fetchRows("SELECT * FROM `tb_standard_pembelajaran`");
    ?>
</head>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Kemaskini</strong> Standard Pembelajaran</h1>
								...
								<div class="card-body pb-0 pt-3">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active">Kemaskini Senarai Standard Pembelajaran</li>
										</ol>
									</nav>
								</div>
							</div>
						...
						<div class="col-12 col-xl-12">
							...
							<div class="card">
								<div class="card-header">
									...
									<h6 class="card-subtitle text-muted">Senarai standard pembelajaran yang telah diisi & digunapakai di dalam cipta borang</h6>
								</div>
											...
											<?php
												if(!empty($dataset)){
													foreach($dataset as $key => $item){
														...
														<tr>
															<td>'.($key + 1).'</td>
															<td>'.$item->standard_pembelajaran.'</td>
