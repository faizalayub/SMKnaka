                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                        ...
                        $carian = ''; // untuk set jika ada tambahan carian

                        // check kalau ada saring   
                        if (isset($_POST['btnSaring'])){
                            if ($_POST['carian'] > 0){
                                $carian = " AND YEAR(tahun) = " . $_POST['carian'];
                            }
                        }
                        ...
                        while ($rwn1 = $rsn1->fetch_assoc()) {
                    ?>
                    <tr>
                      <td><?php echo date('d-m-Y', strtotime($rwn1['tarikh_baru'])); ?></td>
                      <td><?php echo $rwn1['id_subKategori']; ?></td>
                      <td></td>
                    </tr>
                    <?php } ?>
                  </tbody>
