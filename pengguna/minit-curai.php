        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="add-minit-curai.php" class="btn btn-info btn-sm">Tambah Minit Curai</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
            ...
            ?>
             <tr>
                ...
                <td><?= $baca['fullname']; ?></td>
                <td>
                  <a href="minit-curai-view.php?id=<?= $baca['id']; ?>" class="btn btn-info btn-sm">Lihat</a>
                </td> 
              </tr>
              <?php
                                }
