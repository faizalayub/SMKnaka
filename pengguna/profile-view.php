        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="senarai-guru.php">Senarai Guru</a></li>
        ...
        ?>
            ...
            <?php
                    if ($_SESSION['role'] == 2) {
                      ...
                      ON d.id=a.id_gred
                      WHERE b.`status`=1 AND b.id=" . $guruId ;//sini
                    } else {
    ...
    <?php } ?>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center"><?= $baca['jenis_jawatan']; ?></p>
