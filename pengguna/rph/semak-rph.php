    ...
    <?php
        ...
        {    
            ...
            $id_pengguna = $_POST['id_pengguna'];
                ...
                $sn1 = "UPDATE rph_perancangan (id_pengguna,
                                                  id_tingkatan,
                                                  id_kelas,
                                                  subjek ,
                                                  minggu,
            ...
            <div class="container" style="margin-top:1em;">
                <div class="row mb-3">
                    ...
                    <?php 
                        ...
                        FROM rph_perancangan AS a
                        INNER JOIN kelas_lengkap AS b
                        ON b.id=a.id_pengguna WHERE a.id='$id'");
                ...
                <table class="table table-bordered">
                                    <tr>
                                       <th>TINGKATAN</th>
                                       <td colspan="10">
                                       <input value="<?php echo $result['keterangan'];?>"/>
                                       </td>
                                    </tr>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                        <th>TARIKH</th>
                                       <td><input class="form-control" id="tarikh" name="tarikh" type="date" value="<?php echo $result['tarikh'];?>" required /></td>
                                         <th>MASA MULA</th>
                                       <td>
                                ...
                                <button class="btn btn-secondary" type="submit" name="btnSimpan"> Semak & Simpan RPH </button>
                </form>  
            </div>
        </div>
    </div>
