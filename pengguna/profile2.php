                  ...
                  document.getElementById("cancel").onclick = function(){
                    ...
                    <?php
                      if(isset($_FILES["fileImg"]["name"])){
                        ...
                        $query = "UPDATE maklumat_guru SET image = '$imageName' WHERE id_pengguna = " . $_SESSION['id'];
...
<?php
        ...
        ?>
            ...
            <?php
                    if ($_SESSION['role'] == 2) {
                      $panggil = "SELECT  fullname, keterangan, status
                      FROM maklumat_murid AS a
                      JOIN pengguna AS b
                      ON b.id=a.id_pengguna
                      JOIN kelas_lengkap AS c
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Tingkatan</b> <a class="float-right"><?= $baca['keterangan']; ?></a>
                  </li>
                  <li class="list-group-item">
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#mypost" data-toggle="tab">My-Post</a></li>
                  <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Kemaskini</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
...
<!--------------------- SETTING ------------------------>
                  ...
                  <tbody>
                       <tr>
                        ...
                        <td></td>
                        <td>
                        <a href="<?php echo $_SERVER['PHP_SELF'] . "?action=read&id=" . $resultFile['id'] ?>" class="btn btn-primary btn-sm mb-2">Lihat</a> 
                        <a href="<?php echo $_SERVER['PHP_SELF'] . "?action=edit&id=" . $resultFile['id'] ?>" class="btn btn-info btn-sm mb-2">Edit</a>
                        <a href="<?php echo $_SERVER['PHP_SELF'] . "?action=delete&id=" . $resultFile['id'] ?>" class="btn btn-danger btn-sm mb-2">Hapus</a>
                        </td>
                      </tr>
                  </tbody>
                </table>
