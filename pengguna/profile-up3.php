        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Kemaskini Profile</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#edit-data" data-toggle="tab">Edit Data</a></li>
                  <li class="nav-item"><a class="nav-link" href="#edit-koko" data-toggle="tab">Edit Kokurikulum</a></li>
                  <li class="nav-item"><a class="nav-link" href="#edit-gambar" data-toggle="tab">Edit Gambar</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="edit-data">
                    <!-- Post -->
                    <div class="post">
                  ...
                  <!-- /.tab-pane -->
<!--------------------- kokurikulum ------------------------>
                  <div class="tab-pane" id="edit-koko">
                    <form class="form-horizontal">
...
<!--------------------- SETTING EDIT GAMBAR ------------------------>
                  <div class="tab-pane" id="edit-gambar">
          ...
          $.ajax({
            ...
            success:function(response){
              if(response == "Success"){
                ...
                alert("Gambar dah upload tapi direction tak betul// check semula");
              }
            }
          });
        });
