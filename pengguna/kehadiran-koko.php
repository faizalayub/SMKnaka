              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                            $i = 1; 
                            $query = "SELECT * 
                            FROM kehadiran_koko AS a
                            INNER JOIN pengguna AS b
                            ON b.id=a.id_pengguna
                            INNER JOIN kokurikulum AS c
                            ON c.id=a.id_kategori
                            INNER JOIN kategori_kokurikulum AS d
                            ON d.id=a.id_subkategori
                            INNER JOIN kelas_lengkap AS e
                            ON e.id=a.id_kelasLengkap
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?= $baca['kategori_koko']; ?></td>
                        <td><?= $baca['jenis_kokurikulum']; ?></td>
                        <td><?= $baca['fullname']; ?></td>
