  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- bahagian 1-->
        <div class="row">
        <a href="add-opr.php" class="btn btn-warning btn-lg">Tambah OPR Baru</a>
        </div>
         <!-- bahagian 2-->
        <div class="row">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td><b><?php echo date('d-m-Y', strtotime($baca['tarikh'])); ?></b></td>
                        <td><?= $baca['unit']; ?></td>
                        <td><?= $baca['program']; ?></td>
                        <td><?= $baca['fullname']; ?></td>
                        <td><a href="papar-opr.php?id=<?= $baca['id']; ?>" class="btn btn-primary btn-sm">Paparan</a></td>
                      </tr>
                      <?php
                                }
                            }
