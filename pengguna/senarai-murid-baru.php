  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Senarai Murid Baru</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Utama</a></li>
              <li class="breadcrumb-item active">Senarai Murid Baru</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="modal-content">
            ...
            <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Kaum</label>
                    <select name="jenis_kaum" id="jenis_kaum" class="form-control"required>
                  <option value="">Pilih</option>
                  <?php
                                                $sn1 = "SELECT id, jenis_kaum
                                                        FROM kaum
                                                        ";
                                                $rsn1 = mysqli_query($sambung, $sn1);
                                                while ($rw1 = mysqli_fetch_array($rsn1)){
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Jantina</label>
                    <select name="jenis_jantina" id="jenis_jantina" class="form-control"required>
                  <option value="">Pilih</option>
                  <?php
                                                $sn1 = "SELECT id, jenis_jantina
                                                        FROM jantina
                                                        ";
                                                $rsn1 = mysqli_query($sambung, $sn1);
                                                while ($rw1 = mysqli_fetch_array($rsn1)){
                   ?>
                  <option value="<?php echo $rw1['id'];?>"> <?php echo $rw1['jenis_jantina'];?> </option>
                  <?php
                    }
                  ?>
                </select>
