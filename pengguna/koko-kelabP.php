...
<head>
  ...
  <title>PROUD | Kelab Persatuan</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Senarai Ahli Kelab Persatuan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Utama</a></li>
              <li class="breadcrumb-item active">Kelab Persatuan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <th>Kelab / Persatuan</th>
                  ...
                  <?php
                            $i = 1; 
                            $query = "SELECT b.fullname, a.id_pengguna, a.id_kelabP, a.id_kelasLengkap, c.keterangan, e.nama_kelabP, b.`status`, b.role, b.username 
