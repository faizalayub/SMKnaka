...
<head>
  ...
  <title>PROUD | Sukan Permainan</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Senarai Ahli Sukan & Permainan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Utama</a></li>
              <li class="breadcrumb-item active">Sukan Permainan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <th>Sukan Permainan</th>
                  ...
                  <?php
                            $i = 1; 
                            $query = "SELECT b.fullname, a.id_pengguna, a.id_sukanP, a.id_kelasLengkap, c.keterangan, e.jenis_sukanP, b.`status`, b.role, b.username 
                            ...
                            INNER JOIN sukan_permainan AS e
                            ON e.id=a.id_sukanP
                            WHERE status='1'
                            AND role='3'
