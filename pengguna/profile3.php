        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src="<?php echo (!empty($baca['image']) ? '../dist/img/profile/'.$baca['image'] : '../dist/img/profile/avatardefault.png'); ?>" class="profile-image" alt="Profile Image" width="500" height="700">
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <h3 class="my-3"><?php echo $baca['fullname'];?></h3>
              <hr>
              <h4>Maklumat Kelas</h4>
              ...
              <h4 class="mt-3"><small>PAJSK</small></h4>
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-default text-center">
              ...
              <div class="bg-gray py-2 px-3 mt-4">
                <h3 class="mb-0">
                  UNIFORM : <?= $baca['nama_kelabP']; ?>
                </h3>
                <h4 class="mt-0">
                  <small>Jawatan : Ahli Biasa</small>
                </h4>
              </div>
              <div class="bg-gray py-2 px-3 mt-4">
                <h2 class="mb-0">
                  RUMAH SUKAN : <?= $baca['nama_kelabP']; ?>
                </h2>
                <h4 class="mt-0">
                  <small>Jawatan : </small>
                </h4>
