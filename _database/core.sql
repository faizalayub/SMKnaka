...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2023 at 03:45 PM
...
(11, 'AZIZAN BIN ABD HAMID', 'azmid69@gmail.com  ', '691001025601', '5601', 2, 1),
...
INSERT INTO `rph_rancangan` (`id`, `id_pengguna`, `id_kelasLengkap`, `id_subjek`, `tarikh`, `masa_mula`, `masa_tamat`, `tema`, `tajuk`, `standard_kandungan`, `standard_pembelajaran`, `objektif`, `aktiviti`, `refleksi`, `bahan_bantuan`, `created_date`, `changes_date`) VALUES
(4, 1, 1, 7, '2023-03-29', '08:00', '12:30', 'Sirah Nabi Nabi', 'Sirah Nabi Nabi', 'Buku teks', 'Cerita cerita', '<ol><li>Pertanyaann soalan</li><li>Megaji</li></ol>', '<ol><li>Pertanyaann soalan</li><li>Megaji</li></ol>', 'Cemerlang', '', '2023-03-28 13:32:09', '2023-03-28 13:32:09'),
(5, 1, 20, 6, '2023-03-30', '17:59', '17:59', 'Sirah Nabi Nabi', 'Sirah Nabi Nabi', 'Buku teks', 'Cerita cerita', '<ol><li>Fire up your browser game plan, for we need to leverage our synergies, yet mobile friendly</li><li>Blue money into the weeds close the loop digitalize i&acirc;&euro;&trade;ve been doing some research this</li></ol>', '<ol><li>Fire up your browser game plan, for we need to leverage our synergies, yet mobile friendly</li><li>Blue money into the weeds close the loop digitalize i&acirc;&euro;&trade;ve been doing some research this</li></ol>', 'Cemerlang', '', '2023-03-28 14:00:13', '2023-03-28 14:00:13'),
(6, 1, 20, 6, '2023-03-30', '17:59', '17:59', 'Sirah Nabi Nabi', 'Sirah Nabi Nabi', 'Buku teks', 'Cerita cerita', '<ol><li>Fire up your browser game plan, for we need to leverage our synergies, yet mobile friendly</li><li>Blue money into the weeds close the loop digitalize i&acirc;&euro;&trade;ve been doing some research this</li></ol>', '<ol><li>Fire up your browser game plan, for we need to leverage our synergies, yet mobile friendly</li><li>Blue money into the weeds close the loop digitalize i&acirc;&euro;&trade;ve been doing some research this</li></ol>', 'Cemerlang', '', '2023-03-28 14:00:55', '2023-03-28 14:00:55'),
(7, 1, 3, 5, '2023-03-09', '14:04', '17:01', 'Sirah Nabi Nabi', 'Sirah Nabi Nabi', 'Buku teks', 'Cerita cerita', '<p>morning and we need to better wheelhouse. Criticality punter action item, for cta. Enough to wash your face cc me on that, or i need to pee and then g</p>', '<ol><li><p>morning and we need to better wheelhouse. Criticality punter action item, for cta. Enough to wash your face cc me on that, or i need to pee and then g</p></li></ol>', 'Cemerlang', '', '2023-03-28 14:02:15', '2023-03-28 14:02:15');
