...
<?php
   ...
   $query=mysqli_query($sambung,"INSERT INTO pengguna (fullname, username, password, role, status) VALUES('$fullname','$username', '$password','2','9')");
    header('location: ../admin/senarai-guru.php');
